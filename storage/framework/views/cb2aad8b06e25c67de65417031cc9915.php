  ...
  <div class="container d-flex align-items-center justify-content-between">
    <div class="d-flex gap-3">
      <div class="logo d-flex align-items-center">
        <img src="<?php echo e(asset ('frontend/assets/img/logo.png')); ?>" class="img-fluid" alt="">
      </div>
    ...
    <nav id="navbar" class="navbar">
      <ul>
        ...
        <li class="btn-login"><a href="<?php echo e(route('login')); ?>">Masuk</a></li>
      </ul>
      <i class="bi bi-list mobile-nav-toggle"></i>
    </nav><!-- .navbar -->
  </div>
</header><!-- End Header --><?php /**PATH D:\PKK\resources\views/frontend/pages/navbar.blade.php ENDPATH**/ ?>