    ...
    <div class="container">
        <div class="hero-content">
            <div class="hero-logo d-flex align-items-center ms-5 gap-3">
                <img src="<?php echo e(asset('frontend/assets/img/logo.png')); ?>" alt="" height="120" dispay="block">
                <div class="hero-text">
...
<main id="main">
    ...
    <section id="about" class="about section-bg">
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="app-content">
                <div class="app-image">
                    <img src="<?php echo e(asset('frontend/assets/img/gadget.png')); ?>" alt="">
                </div>
            ...
            <div class="profile-content">
                ...
                <div class="profile-image">
                    <img src="<?php echo e(asset('frontend/assets/img/ketuapkk.png')); ?>" alt="">
                </div>
    ...
    <section id="portfolio" class="portfolio">
        ...
        <div class="gallery-wrapper">
            ...
            <button class="nav prev">
                <img src="<?php echo e(asset('frontend/assets/img/kiri.png')); ?>" alt="">
            </button>
            ...
            <div class="gallery-container" id="slider">
                ...
                <div class="gallery-card">
                    <img src="<?php echo e(asset('frontend/assets/img/galeri1.jpeg')); ?>">
                ...
                <div class="gallery-card">
                    <img src="<?php echo e(asset('frontend/assets/img/galeri2.jpeg')); ?>">
                    <div class="gallery-info">
            ...
            <button class="nav next">
                <img src="<?php echo e(asset('frontend/assets/img/kanan.png')); ?>" alt="">
            </button>
        </div>
    ...
    <section id="service" class="services section-bg">
        ...
        <div class="container" data-aos="fade-up">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $berita; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                        <div class="card custom-card">
                            <div class="card-img">
                                <?php if($item->image): ?>
                                    <img src="<?php echo e(asset('storage/' . $item->image)); ?>" alt="<?php echo e($item->judul); ?>" class="img-fluid" style="height: 200px; object-fit: cover;">
                                <?php else: ?>
                            ...
                            <div class="card-body">
                                ...
                                <small class="text-muted"><?php echo e($item->created_at->format('d F Y')); ?></small>
                                <br>
                                <a href="<?php echo e(route('berita.show', $item->id)); ?>" class="btn btn-sm btn-primary mt-2">Baca Selengkapnya</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="text-center mt-4">
                <a href="<?php echo e(route('berita.index')); ?>" class="btn btn-primary">Lihat Semua Berita</a>
            </div>
        </div>
    </section>
    ...
    <section id="pengumuman" class="services">
        ...
        <div class="container" data-aos="fade-up">
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                        <div class="card custom-card">
                            <div class="card-body">
                                <h5><?php echo e($item->judul); ?></h5>
                                <p><?php echo e(Str::limit($item->deskripsi, 100)); ?></p>
                                <small class="text-muted"><strong>Tempat:</strong> <?php echo e($item->tempat); ?></small>
                                <br>
                                <small class="text-muted"><strong>Tanggal:</strong> <?php echo e($item->tanggal->format('d F Y')); ?></small>
                                <br>
                                <a href="<?php echo e(route('pengumuman.show', $item->id)); ?>" class="btn btn-sm btn-primary mt-2">Lihat Detail</a>
                            </div>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            ...
            <!-- End Card Item -->
            <div class="text-center mt-4">
                <a href="<?php echo e(route('pengumuman.index')); ?>" class="btn btn-primary">Lihat Semua Pengumuman</a>
            </div>
        </div>
    </section>
...
<?php echo $__env->make('frontend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PKK\resources\views/home.blade.php ENDPATH**/ ?>